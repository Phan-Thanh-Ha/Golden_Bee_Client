                ...
                <View style={MainStyles.rowMargin}>
                  <View style={MainStyles.flexRowFlexStart}>
                    <Image
                      ...
                      style={{ width: 22, height: 22 }}
                    />
                    <Text style={MainStyles.textCardJob}>Tên khách hàng :{data?.DataService?.CustomerName}</Text>
                  </View>
                </View>
                <View style={MainStyles.rowMargin}>
                  <View style={MainStyles.flexRowFlexStart}>
                    <Image
                      ...
                      style={{ width: 22, height: 22 }}
                    />
                    <Text style={MainStyles.textCardJob}>Số điện thoại :{data?.DataService?.CustomerPhone}</Text>
                  </View>
                </View>
              </View>
            </View>
